...
from vllm.validation.plugins import ModelType
from vllm.validation.plugins import ModelValidationPlugin
...
class SignatureEnforcement(ModelValidationPlugin):
    ...
    def model_validation_needed(
        self, model_type: ModelType, model_path: str
    ) -> bool:
